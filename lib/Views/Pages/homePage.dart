...
import '../../API Requests/apiRequest.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    singleMovie = getSingleMovie(urlTrening);
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(
                          img_base + snapshot.data.imgPoster,
                        ),
                        fit: BoxFit.cover,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    fit: BoxFit.fill,
                                    image: NetworkImage(
                                      img_base + snapshot.data[index].imgPoster,
                                    ),
                                  ),
                                ),
                              ),
